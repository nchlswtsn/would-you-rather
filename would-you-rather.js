...
function random() {
  ...
  if(itemOne !== itemTwo && choices.length > 0){
    ...
    //
    var itemOneIndex = choices.indexOf(itemOne);
    var itemTwoIndex = choices.indexOf(itemTwo);

    console.log("Choices:", choices);
    choices.splice(itemOneIndex, 1);
    // TODO: add if larger than itemoneindex
    choices.splice(itemTwoIndex - 1, 1);
    console.log("itemOne:", itemOne);
    console.log("itemOne:", itemTwo);

    console.log("itemoneindex:", itemOneIndex);
    console.log("itemtwoindex:", itemTwoIndex);
